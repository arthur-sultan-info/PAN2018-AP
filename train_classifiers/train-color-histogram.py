...
def train(options):
	...
	print('Training classifier for color histogram -- This may take some time..')
	...
	for clf in classifiers:
		current_scores = cross_val_score(clf, X, y, cv=10, scoring='accuracy', n_jobs=2, verbose=1)
	...
	pickle.dump( best_classifier, open( "trained-classifiers/color-histogram-classifier.p", "wb" ) )
	
	print('Best classifier saved for color histogram:', best_classifier)
